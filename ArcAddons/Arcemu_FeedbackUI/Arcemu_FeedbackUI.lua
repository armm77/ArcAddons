...
function FeedbackUI_EnableSurvey ()
	...
	FeedbackUIWelcomeFrameSurveysIcon:SetTexture("Interface\\AddOns\\Arcemu_FeedbackUI\\UI-Icon-Survey");
end
...
function FeedbackUI_DisableSurvey (objectName)
	...
	FeedbackUIWelcomeFrameSurveysTint:SetVertexColor(vr, vg, vb, va);
	FeedbackUIWelcomeFrameSurveysLabel:SetTextColor(r, g, b, a);
	FeedbackUIWelcomeFrameSurveysIcon:SetTexture("Interface\\AddOns\\Arcemu_FeedbackUI\\UI-Icon-Survey-Disabled");
end
	...
	function FeedbackUI_SetupSpell (link) 
		...
		function FeedbackUI_SetupTalent(link)
			...
			function FeedbackUI_ItemTooltip (tooltip, x, y)
				...
				tooltip:AddTexture("Interface\\AddOns\\Arcemu_FeedbackUI\\UI-Icon-Blizzard-Tooltip");
			...
			function FeedbackUI_SpawnTooltip ()
				...
				GameTooltip:AddTexture("Interface\\AddOns\\Arcemu_FeedbackUI\\UI-Icon-Blizzard-Tooltip");
				GameTooltip:Show();
			end
