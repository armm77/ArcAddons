...
for i = 1, NUM_CHAT_WINDOWS do
 ...
 button:SetPoint("TOPLEFT", -30, 65)
 button:SetHeight(24) --LoadUp Height
 button:SetWidth(24) --LoadUp Width
 button:SetNormalTexture("Interface\\Icons\\"..BUTTON_ICON)
 button:SetHighlightTexture("Interface\\Buttons\\ButtonHilight-Square")
 button:SetScript("OnClick", function() Copy(cf) end)
 button:SetScript("OnEnter", function()
 button:SetHeight(24) --Big Height
 button:SetWidth(24) --Big Width
 ...
 button:SetHeight(24) --Small Height
 button:SetWidth(24) --Small Width
 GameTooltip:Hide()
 end)
