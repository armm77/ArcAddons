...
local sendto = "GUILD";
ConsoleAddMessage("ARCGM-DEBUGMSG: \""..text.."\"");
 if BoolChat then
...
function ArcGM_NOTSUPPORTED()
		 ShowMessage("Your WoW Client ("..wowbuild..") is not supported by ArcGM "..ArcGMversion.." r"..ArcGMbuild.."!")
		 ShowMessage("You may experience undesired results, please report issues on the ArcAddon forums. You may also look for an update for this version \(("..wowbuild..")\) or please state it in the report.")
 end
